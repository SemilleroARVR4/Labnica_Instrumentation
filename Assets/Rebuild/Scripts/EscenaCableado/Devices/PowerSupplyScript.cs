...
public class PowerSupplyScript : MonoBehaviour
{
    ...
    public void TurnOnCircuit(bool remote)
    {
        //Mp Callback
        if(!remote)
            FindObjectOfType<MPGameMgr>().photonView.RPC("PowerOn",Photon.Pun.RpcTarget.Others);
        ...
        //Registramos la infromaci�n del chequeo
        /*
